...
public class AddSupplier extends javax.swing.JFrame {
    ...
    public AddSupplier() {
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
              ...
              ResultSet rs = s.executeQuery("SELECT MAX(ID) FROM `suppliers`");
              if(rs.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
              ...
              Connection con = DriverManager.getConnection("jdbc:mysql://localhost:                              3306/trainingproject","root","");
              Statement s = con.createStatement();
              int sql = s.executeUpdate("INSERT INTO `suppliers`( `id`,`Name`, `Phone`, `Address`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"')");
            s.close();
            con.close();
            
            JOptionPane.showMessageDialog(null,"Supplier is added.");
            dispose();

...
public class SupplierSearch extends javax.swing.JFrame {
    ...
    String i,n;
    public SupplierSearch(String i,String n) {
        initComponents();
        centerFrame();
        this.i = i;
        this.n = n;
        ...
        ResultSet rs = st.executeQuery ("SELECT * FROM suppliers WHERE ID LIKE '%" + i +  "%' or Name LIKE '%" + i + "%'");
              while(rs.next())
              {
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
          ...
          NewInvoicePur newpur = new NewInvoicePur(ID, Name);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            String i,n;
            public void run() {
                new SupplierSearch(i,n).setVisible(true);
            }
        });
    }

 ...
 * @author Sarepta
 */
public class ClientSearch1 extends javax.swing.JFrame {
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        String ID = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
          ...
          NewReceipt nr = new NewReceipt(ID,Name,USER);
          nr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientSearch1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            private String s;
            public void run() {
                new ClientSearch1(s).setVisible(true);
            }
        });
    }
